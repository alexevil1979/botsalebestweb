...
🔧 **Применить изменения на VPS:** см. [UPDATE_VPS.md](UPDATE_VPS.md) ⭐ ВСЕГДА ИСПОЛЬЗУЙТЕ ЭТО - ПОЛНЫЕ КОМАНДЫ  
...
> **🔧 Для быстрого применения изменений см. [APPLY_ON_SERVER.md](APPLY_ON_SERVER.md)**
...
- `/var/log/apache2/botsalebestwebstudio_error.log`
...
2. Убедитесь, что все сервисы запущены (MySQL, Redis, Apache)
